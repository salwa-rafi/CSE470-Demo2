 ...
 * @author imtiz
 */
public class PendingApprovalsControllerTest implements Initializable {
    
    
ObservableList <PendingApprovalsControllerTest.EmployeeTable> elist = FXCollections.observableArrayList();
    @FXML
    private JFXButton pending_btn;
    @FXML
    private TableColumn<PendingApprovalsControllerTest.EmployeeTable,String>ALLG_gfid;
    @FXML
    private TableColumn<PendingApprovalsControllerTest.EmployeeTable,String> ALLG_name;
    @FXML
    private TableColumn<PendingApprovalsControllerTest.EmployeeTable,String> ALLG_address;
    @FXML
    private TableColumn<PendingApprovalsControllerTest.EmployeeTable,String> ALLG_salary;
    @FXML
    private TableColumn<PendingApprovalsControllerTest.EmployeeTable,String> ALLG_location;
    @FXML
    private TableColumn<PendingApprovalsControllerTest.EmployeeTable,String> ALLG_remarks;
    @FXML
    private TableView<PendingApprovalsControllerTest.EmployeeTable>ALLG_table;
    Connection con;
    Statement stm;
    ResultSet rest;
    @FXML
   ...
   private void testinitCol() {
    ...
    private void show_btn_press(ActionEvent event) throws SQLException {
      ...
      PendingApprovalsControllerTest.EmployeeTable Employee = new PendingApprovalsControllerTest.EmployeeTable (stgfid,stcname,staddress,stcsalary,stlocation,stcremarks);
      elist.add(Employee);
            }
