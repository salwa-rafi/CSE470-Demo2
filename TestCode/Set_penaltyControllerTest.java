 ...
 * @author imtiz
 */
public class Set_penaltyControllerTest implements Initializable {
    ...
    private void confirm_btn_press(ActionEvent event) throws SQLException {
        ...
        try {
            ...
            Logger.getLogger(Set_penaltyControllerTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void fetch() {
        ...
        try {
            ...
            //Set_penaltyControllerTest.id.setText(String.valueOf(id));
